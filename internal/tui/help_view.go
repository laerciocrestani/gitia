...
func helpContent() string {
	lines := []string{
		...
		"  ↑↓      Scroll / navegar branches (lista numerada)",
		"  esc     Voltar",
		"",
		"Na tela de add",
		"  (●)/( ) Todos no topo — space marca/desmarca todos",
		"  ●/○       Marcar arquivo individual",
		"  space     Alternar seleção (Todos ou arquivo)",
		"  Enter     git add nos selecionados; em Todos → git add .",
